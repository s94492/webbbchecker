...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/root/.nvm/versions/node/v20.16.0/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH=/root/.nvm/versions/node/v20.16.0/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/snap/bin
